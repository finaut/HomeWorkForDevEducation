        ...
        private static void Task1()
        {
            ...
            do
            {
                ...
                else
                {
                    ...
                    {
                        case "+":
                            Console.WriteLine(calculate.Plus(firstNumber, lastNumber));
                            break;
                        case "-":
                            Console.WriteLine(calculate.Minus(firstNumber, lastNumber));
                            break;
                        case "*":
                            Console.WriteLine(calculate.Multiplication(firstNumber, lastNumber));
                            break;
                        case "/":
                            Console.WriteLine(calculate.Division(firstNumber, lastNumber));
                            break;
                        default:
